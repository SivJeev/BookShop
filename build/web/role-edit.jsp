...
<head>
    ...
    <title>Edit Role - Bookshop Management System</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <h1 class="mb-0">
                <i class="fas fa-edit me-3"></i>Edit Role
            </h1>
            <p class="mb-0 mt-2 opacity-75">Update role information</p>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                        ...
                        <form action="role" method="post">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" id="description" name="description" 
                                          rows="3"><%= role.getDescription() != null ? role.getDescription() : "" %></textarea>
                ...
                <div class="card form-card mt-4">
                    <div class="card-body">
                        ...
                        <p><strong>Role ID:</strong> <%= role.getId() %></p>
                        ...
                        <p><strong>Last Updated:</strong> 
                            <%= java.time.format.DateTimeFormatter.ofPattern("MMM dd, yyyy HH:mm")
                                .format(role.getUpdatedAt().toLocalDateTime()) %>
                        </p>
                        <% } %>
                        
                        <% if (role.getPermissions() != null && !role.getPermissions().isEmpty()) { %>
                        <p><strong>Permissions:</strong> <%= role.getPermissions().size() %> assigned</p>
                        <% } else { %>
                        <p><strong>Permissions:</strong> No permissions assigned</p>
                        <% } %>
                        
                        <a href="role?action=permissions&id=<%= role.getId() %>" class="btn btn-info">
